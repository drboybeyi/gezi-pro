import { loginUser, registerUser, getFirebaseErrorMessage, isConfigured } from '../firebase-config.js';
  ...
  render() {
    return `
      <div class="login-screen">
        ...
        <div class="login-title">Gezi Pro</div>
        <div class="login-sub">Gezdiğin yerleri fotoğraf ve haritada topla</div>

        <div class="login-card">
          <h2 id="loginHeading">Giriş Yap</h2>
          ${isConfigured ? '' : `
            <div class="login-warn">
              ⚠️ Firebase config eksik (placeholder). Giriş için
              <code>js/firebase-config.js</code> doldurulmalı.
            </div>`}
          <div id="loginError" class="login-error" style="display:none"></div>

          <div class="form-group">
            <label class="form-label">E-posta</label>
            <input type="email" id="loginEmail" class="form-control" placeholder="gezgin@ornek.com" autocomplete="email">
          </div>
          <div class="form-group">
